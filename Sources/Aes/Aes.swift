...
public final class AesTransposer: EncryptTransposer {
	...
	static let InvSBox: [Byte] = [
		...
		0x6e,
		0x47, 0xf1, 0x1a, 0x71, 0x1d, 0x29, 0xc9, 0x89, 0x6f, 0xb7, 0x62, 0x0e, 0xaa, 0x18, 0xbe,
		0x1b,
...
public final class AesExpander: KeyExpander {
	public init() {}
	public func expandKey(key: Symmetric.Block) throws -> [Symmetric.Block] {
		return [key]
	}
}
